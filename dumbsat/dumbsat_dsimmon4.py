...
def plot_results(problem_sizes, exec_times, satisfiable_flags, degree=2, filename="sat_solver_plot.png"):
    ...
    plt.title(f'DUMBSAT Solver Execution Time vs Problem Size')
    plt.legend()
...
# print test results
plot_results(problem_sizes, exec_times, satisfiable_flags, degree=5, filename="dumbsat_solver_plot_dsimmon4.png")
